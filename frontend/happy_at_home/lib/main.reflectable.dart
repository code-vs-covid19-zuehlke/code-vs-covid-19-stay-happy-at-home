  ...
  const prefix0.JsonSerializable(): r.ReflectorData(
      <m.TypeMirror>[
        r.NonGenericClassMirrorImpl(
            ...
            {},
            {
              r'': (b) => ({id, name, photo, feelingRecords}) => b
                  ? prefix1.User(
        ...
        r.NonGenericClassMirrorImpl(
            ...
            {},
            {},
            {r'': (b) => ({emoji}) => b ? prefix3.Feeling(emoji: emoji) : null},
            -1,
            2,
            const <int>[],
            const <Object>[prefix0.jsonSerializable],
      ...
      <m.DeclarationMirror>[
        ...
        r.MethodMirrorImpl(r'', 0, 1, -1, 1, 1, const <int>[], const <int>[6],
        ...
        r.MethodMirrorImpl(r'', 0, 4, -1, 4, 4, const <int>[], const <int>[9],
            const prefix0.JsonSerializable(), const []),
      ...
      <Type>[
        ...
        prefix6.Emoji,
        String,
        const m.TypeValue<Set<prefix3.Feeling>>().type,
        Set,
        int,
        bool,
        Type,
