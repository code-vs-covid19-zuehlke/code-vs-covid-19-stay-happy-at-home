  ...
  private static Map<Emoji, Set<Emotion>> emotionToEmotionMatrix = new HashMap<>() {
    {
      ...
      put(GRINNING_FACE_WITH_SMILING_EYES, Emotion.getAll());
      ...
      put(YAWNING_FACE, Emotion.getAll());
      ...
      put(UNAMUSED_FACE, Emotion.getAll());
      ...
      put(FACE_WITH_MEDICAL_MASK, Emotion.getAll());
      put(FACE_SCREAMING_IN_FEAR, Set.of(HAPPY, RELAXED, AWWW, ENTERTAINED));
      put(PANDA, Emotion.getAll());
